...
const FORM_CONFIG = {
  ...
  '變更繳別':     { label: '繳費方式變更申請書', folder: '保額變更申請書', note: '請確認新繳別的繳費期限與寬限期。' },
  '變更信用卡':   { label: '信用卡授權書',       folder: '信用卡授權書',   note: '請備妥新卡卡號後填寫，授權日期請填當天。' },
  '變更扣款方式': { label: '扣款帳號變更申請書', folder: '保額變更申請書', note: '請附上新帳號存摺封面影本。' },
  '減額繳清':     { label: '減額繳清申請書',     folder: '保額變更申請書', note: '辦理後保額將按比例調降，不可還原，請審慎評估。' },
  '停效復效':     { label: '停效復效申請書',     folder: '保額變更申請書', note: '復效需補繳欠費保費及利息，請確認金額。' },
